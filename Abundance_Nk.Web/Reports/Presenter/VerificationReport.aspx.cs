...
{
    public partial class VerificationReport : System.Web.UI.Page
    {
        ...
        private void DisplayReport(Session session, Department department, Programme programme)
        {
            try
            {
                ...
                List<Model.Model.ApplicantResult> resultList = resultLogic.GetVerificationReport(department, session, programme);

                string reportPath = "";
                string bind_ds = "dsApplicantResult";
                reportPath = @"Reports\VerificationReport.rdlc";
        ...
        private void PopulateAllDropDown()
        {
            try
            {
                ...
                List<Model.Model.Programme> programmeList = programmeLogic.GetModelsBy(p => p.Programme_Id != (int)Programmes.HNDPartTime);
