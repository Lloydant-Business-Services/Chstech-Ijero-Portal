...
namespace Abundance_Nk.Web.Reports.Presenter
{
    ...
    public partial class CARawScoreSheet : System.Web.UI.Page
    {
        string deptId;
        string progId;
        string sessionId;
        ...
        private void DisplayReportBy(Session session, Semester semester,Course course,Department department, Level level,Programme programme)
        {
            try
            {
                ...
                List<ExamRawScoreSheetReport> examRawScoreSheetReportList = studentExamRawScoreSheetResultLogic.GetCAScoreSheetBy(session, semester, course, department, level, programme);
                string bind_dsStudentPaymentSummary = "dsExamRawScoreSheet";
                string reportPath = @"Reports\Result\CARawScoreSheet.rdlc";
