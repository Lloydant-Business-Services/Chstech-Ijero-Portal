...
{
    public partial class OldStudentCount : System.Web.UI.Page
    {
        ...
        private void DisplayReportBy(Session session)
        {
            try
            {
                ...
                List<StudentDetailFormat> list = studentLogic.GetOldStudentCount(session);

                string bind_dsAdmissionList = "dsStudent";
                string reportPath = @"Reports\OldStudentCount.rdlc";
