...
namespace Abundance_Nk.Web.Reports.Presenter
{
    ...
    public partial class StudentDetailReport : System.Web.UI.Page
    {
        ...
        private void DisplayReportBy(Session session, Department department, Programme programme, Level level)
        {
            try
            {
                ...
                List<Abundance_Nk.Model.Model.StudentReport> studentReportList = studentLogic.GetStudentInformationBy(department, programme, session, level);
