<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicantPhotoCardZip.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.ApplicantPhotoCardZip" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-inline">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlProgramme" cssclass="form-control" runat="server" AutoPostBack="True" ></asp:DropDownList>
                            </div>
