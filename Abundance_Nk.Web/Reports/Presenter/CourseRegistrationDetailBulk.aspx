<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseRegistrationDetailBulk.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.CourseRegistrationDetailBulk" %>
                ...
                <div class="form-group">
                   ...
                   <asp:DropDownList ID="ddlSession" class="form-control" runat="server" Height="35px" Width="200px">
                    ...
                    <asp:DropDownList ID="ddlDepartment" class="form-control" runat="server" Height="35px" Width="250px">
                      ...
                      <asp:DropDownList ID="ddlSemester" class="form-control" runat="server" Height="35px" Width="250px">
                    </asp:DropDownList>
