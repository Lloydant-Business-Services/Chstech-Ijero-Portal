...
namespace Abundance_Nk.Web.Reports.Presenter
{
    ...
    public partial class Acceptance_Report : System.Web.UI.Page
    {
        ...
        private void DisplayReportBy(Department department, Programme programme)
        {
            try
            {
                Session s = new Model.Model.Session() { Id = 1};
                PaymentLogic paymentLogic = new PaymentLogic();
                var report = paymentLogic.GetRemitaReportBy(s,department, programme);
