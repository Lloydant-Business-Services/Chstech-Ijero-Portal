<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmissionListReport.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.AdmissionListReport" %>
                             ...
                             <div class="col-md-12">
                                <div class="form-inline">
                                    ...
                                    <asp:Button ID="btnDisplayReport" cssclass="btn btn-danger mr5" runat="server" Text="Display Report" OnClick="btnDisplayReport_Click" />
                                         <asp:Button ID="btnBulkReport" cssclass="btn btn-danger mr5" runat="server" Text="Bulk Report" OnClick="btnBulkReport_Click"/>
                                     </div>
