<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiplomaClassReport.aspx.cs" Inherits="Abundance_Nk.Web.Reports.Presenter.Result.DiplomaClassReport" %>
                    ...
                    <div class="panel-body">
                        <%-- <div class="form-inline">
                                ...
                                <div class="form-group" >
                                    <asp:RadioButtonList ID="rblSortOption" runat="server" RepeatDirection="Horizontal" CssClass="radiobuttonlist2" >
                                        <asp:ListItem Value="2">CGPA</asp:ListItem>
                                        <asp:ListItem Value="2">Matriculation Number</asp:ListItem>
                                        <asp:ListItem Value="2">Name</asp:ListItem>
                                        <asp:ListItem Value="1">Classification</asp:ListItem> 
                                    </asp:RadioButtonList>
                                </div>
                             </div>--%>
                        ...
                        <div class="form-inline">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label class="sr-only" for="ddlDepartmentOption"></label>
...
<%--                                 <asp:Button ID="btnMainDisplayReport" cssclass="btn btn-success mr5" runat="server" Text="Main Report" OnClick="btnMainDisplayReport_Click" />&nbsp;
                                 <asp:Button ID="btnCarryOverDisplayReport" cssclass="btn btn-success mr5" runat="server" Text="CarryOver Report" OnClick="btnCarryOverDisplayReport_Click" />&nbsp;
                                 <asp:Button ID="btnExtraYearDisplayReport" cssclass="btn btn-success mr5" runat="server" Text="ExtraYear Report" OnClick="btnExtraYearDisplayReport_Click" />--%>
                             </div>
                             <div class="form-group">
