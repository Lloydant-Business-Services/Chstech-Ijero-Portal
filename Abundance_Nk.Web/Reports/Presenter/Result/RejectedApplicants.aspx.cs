...
{
    public partial class RejectedApplicants : System.Web.UI.Page
    {
        ...
        private void DisplayReport(Session session, Department department, Programme programme)
        {
            ...
            {   
                ...
                List<Model.Model.ApplicantResult> resultList = resultLogic.GetRejectedApplicants(programme, department, session);

                string reportPath = "";
                string bind_ds = "dsHNDApplicants";
                reportPath = @"Reports\Result\RejectedApplicants.rdlc";

                rv.Reset();
                rv.LocalReport.DisplayName = "Rejected Applicants";
