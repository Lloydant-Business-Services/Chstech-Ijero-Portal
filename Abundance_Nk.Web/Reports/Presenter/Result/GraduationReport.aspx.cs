...
{
    public partial class GraduationReport : System.Web.UI.Page, IReport
    {
        ...
        private void DisplayReportBy(SessionSemester session, Level level, Programme programme, Department department, int type)
        {
            try
            {
                ...
                {
                    resultList = resultLogic.GetGraduationListByOption(session, level, programme, department, DepartmentOption, type);
                }
                else
                {
                    resultList = resultLogic.GetGraduationList(session, level, programme, department, type);
                }
