...
{
    public partial class HNDRejectedApplicants : System.Web.UI.Page
    {
        ...
        private void DisplayReport(Session session, Department department, Programme programme)
        {
            ...
            {   
                ...
                List<Model.Model.ApplicantResult> resultList = resultLogic.GetRejectedHNDApplicants(programme, department, session);

                string reportPath = "";
                string bind_ds = "dsHNDApplicants";
                reportPath = @"Reports\Result\HNDRejectedApplicants.rdlc";
        ...
        private void PopulateAllDropDown()
        {
            try
            {
                ...
                List<Model.Model.Programme> programmeList = programmeLogic.GetModelsBy(p => p.Programme_Id == 3 || p.Programme_Id == 4);
