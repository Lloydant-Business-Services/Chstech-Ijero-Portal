    ...
    public partial class HNDApplicantDetails : System.Web.UI.Page
    {
        ...
        private void DisplayReport(Session session, Department department, Programme programme)
        {
            try
            {
                ...
                {
                    resultList = resultLogic.GetHNDApplicants(programme, department, DepartmentOption, session);
                }
                else
                {
                    resultList = resultLogic.GetHNDApplicants(programme, department, session);
                }
