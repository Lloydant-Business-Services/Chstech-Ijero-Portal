...
{
    public partial class DiplomaClassReport : System.Web.UI.Page, IReport
    {
        ...
        private void DisplayReportBy(SessionSemester session, Level level, Programme programme, Department department)
        {
            try
            {
                ...
                {
                    resultList = resultLogic.GetDiplomaClassListByOption(session, level, programme, department, DepartmentOption);
                }
                else
                {
                    resultList = resultLogic.GetDiplomaClassList(session, level, programme, department);
                }
                ...
                reportPath = @"Reports\Result\DiplomaClassSheet.rdlc";
        ...
        protected void btnDisplayReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DisplayReportBy(SelectedSession, Level, Programme, Department);
            }
            catch (Exception ex)
            {
                lblMessage.Text = ex.Message;
