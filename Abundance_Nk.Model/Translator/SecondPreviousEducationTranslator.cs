...
{
    public class SecondPreviousEducationTranslator : TranslatorBase<SecondPreviousEducation, APPLICANT_SECOND_PREVIOUS_EDUCATION>
    {
        ...
        public SecondPreviousEducationTranslator()
        {
        ...
        public override SecondPreviousEducation TranslateToModel(APPLICANT_SECOND_PREVIOUS_EDUCATION entity)
        {
            try
            {
                SecondPreviousEducation previousEducation = null;
                if (entity != null)
                {
                    previousEducation = new SecondPreviousEducation();
                    previousEducation.Id = entity.Applicant_Second_Previous_Education_Id;
        ...
        public override APPLICANT_SECOND_PREVIOUS_EDUCATION TranslateToEntity(SecondPreviousEducation previousEducation)
        {
            try
            {
                APPLICANT_SECOND_PREVIOUS_EDUCATION entity = null;
                if (previousEducation != null)
                {
                    entity = new APPLICANT_SECOND_PREVIOUS_EDUCATION();
                    entity.Applicant_Second_Previous_Education_Id = previousEducation.Id;
